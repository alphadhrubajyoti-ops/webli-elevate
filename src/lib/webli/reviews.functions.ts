...
const reviewSchema = z.object({
  ...
  content: z.string().trim().min(12, "Please write a little more about your experience.").max(600, "Review is too long."),
...
function publicClient() {
  ...
  if (!url || !key) throw new Error("Database connection is not configured. Please try again later.");
